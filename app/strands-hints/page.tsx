  ...
  return (
    <>
      ...
      <div className="mt-8 flex flex-wrap gap-3 text-sm">
        <Link prefetch={false} href="/todays-strands-answer" className="rounded-md border border-slate-300 px-4 py-2 hover:bg-slate-50">Reveal today&apos;s answer</Link>
        <Link prefetch={false} href="/strands-spangram-helper" className="rounded-md border border-slate-300 px-4 py-2 hover:bg-slate-50">Open spangram helper</Link>
