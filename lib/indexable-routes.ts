...
const staticRoutes: IndexableRoute[] = [
  ...
  { path: "/todays-pips-answer", label: "Today's Pips Answer", category: "Daily Hints", changeFrequency: "daily", priority: 0.8 },
  { path: "/todays-mini-crossword-answer", label: "Today's Mini Crossword Answer", category: "Daily Hints", changeFrequency: "daily", priority: 0.8 },
  { path: "/todays-crossword-answer", label: "Today's Crossword Answer", category: "Daily Hints", changeFrequency: "daily", priority: 0.8 },
